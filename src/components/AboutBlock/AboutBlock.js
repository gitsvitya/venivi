    ...
    <div className={styles.container}>
      ...
      <div className={styles.textBoxes}>
        <div className={styles.textBox}>
          ...
          <p className={styles.textBoxParagraph}>Venivi was a task platform for giveaways where advertisers could interact with users by various prize drawings and quizzes. It was released in 2013.</p>
        </div>
        <div className={styles.textBox}>
        ...
        <div className={styles.textBox}>
          ...
          <p className={styles.textBoxParagraph}>The project was closed in 2014 on the toughed VK.com contest rules, what makes the work of third-party resource work impossible.</p>
        </div>
      </div>
    </div>
  );
